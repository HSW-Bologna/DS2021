...
extern const pman_page_t page_drive, page_splash, page_main, page_network, page_settings, page_test, page_log,
    page_tech_settings, page_stats, page_program, page_step;
