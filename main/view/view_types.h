...
typedef enum {
    ...
    VIEW_CONTROLLER_MESSAGE_CODE_TOGGLE_COMMUNICATION,
    ...
    VIEW_CONTROLLER_MESSAGE_CODE_EXPORT_CURRENT_MACHINE,
    VIEW_CONTROLLER_MESSAGE_CODE_IMPORT_CURRENT_MACHINE,
    VIEW_CONTROLLER_MESSAGE_CODE_CHANGE_REMAINING_TIME,
    VIEW_CONTROLLER_MESSAGE_CODE_CHANGE_TEMPERATURE,
